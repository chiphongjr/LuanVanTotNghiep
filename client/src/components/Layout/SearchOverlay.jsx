...
//           onClick={() => dispatch(toggleSearchBar())} // click ngoài sẽ đóng
//         >
//           <div
//             className="relative z-10 animate-slide-in-top"
//             onClick={(e) => e.stopPropagation()} // tránh click bên trong đóng overlay
//           >
